...
function startGame() {
    ...
    setNextQuestion();
    quizScore = 0; 
    document.getElementById('right-answers').innerText = quizScore; // Initialize score display
}
...
const questions = [
    {
        question: 'Which one of these is a popular JavaScript library for building user interfaces?',
        answers: [
